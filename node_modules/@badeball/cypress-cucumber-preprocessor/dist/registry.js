...
class Registry {
    ...
    defineCaseHook(keyword, options, fn) {
        ...
        this.preliminaryHooks.push(Object.assign({ node: parseMaybeTags(options.tags), implementation: fn, keyword: keyword, position: (0, source_map_1.maybeRetrievePositionFromSourceMap)(this.experimentalSourceMap), order: order !== null && order !== void 0 ? order : exports.DEFAULT_HOOK_ORDER }, remainingOptions));
    }
    ...
    defineStepHook(keyword, options, fn) {
        const { order } = options, remainingOptions = __rest(options, ["order"]);
        this.stepHooks.push(Object.assign({ node: parseMaybeTags(options.tags), implementation: fn, keyword: keyword, position: (0, source_map_1.maybeRetrievePositionFromSourceMap)(this.experimentalSourceMap), order: order !== null && order !== void 0 ? order : exports.DEFAULT_HOOK_ORDER }, remainingOptions));
    }
