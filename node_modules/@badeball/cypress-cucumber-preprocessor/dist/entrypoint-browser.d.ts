...
declare function defineBeforeAll(options: IRunHookOptions, fn: IRunHookBody): void;
declare function defineBeforeAll(fn: IRunHookBody): void;
declare function defineAfterAll(options: IRunHookOptions, fn: IRunHookBody): void;
