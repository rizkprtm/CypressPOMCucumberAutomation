...
async function diagnose(configuration) {
    ...
    for (const testFile of testFiles) {
        ...
        const outputFileName = path_1.default.join(configuration.cypress.projectRoot, ".output-" + randomPart + ".cjs");
        let registry;
        ...
        try {
            ...
            if (esbuildResult.errors.length > 0) {
                ...
                throw new Error(`Failed to compile step definitions of ${testFile}, with errors shown above...`);
            }
        ...
        const astIdMap = (0, ast_1.createAstIdMap)(gherkinDocument);
                ...
                for (const step of pickle.steps) {
                    ...
                    if (matchingStepDefinitions.length === 0) {
                        ...
                        result.unmatchedSteps.push({
                            ...
                            type: (0, assertions_1.assertAndReturn)(step.type, "Expected pickleStep to have a type"),
                            argument,
