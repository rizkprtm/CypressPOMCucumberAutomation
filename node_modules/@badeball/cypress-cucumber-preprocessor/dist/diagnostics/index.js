...
function createUnmatchedStep(projectRoot, unmatch) {
    ...
    return createLineBuffer((append) => {
        ...
        for (const generatedExpression of generatedExpressions) {
            append("");
            append((0, strings_1.indent)((0, snippets_1.generateSnippet)(generatedExpression, "Context", unmatch.argument), {
                count: 2,
            }));
        }
    });
...
async function execute(options) {
    const cypress = (0, cypress_configuration_1.getConfiguration)(Object.assign(Object.assign({}, options), { testingType: "e2e" }));
